...
def baner():
    ...
    print(f"""
        ...
        {p}{b}╚  ╚═╝ {d} ┴─┘┴┴ ┴└─┘└  └─┘┴─┘
{ab}-----------------------------------------------
{d}XNXX.COM  : {g}https://Ng
{d}Message  : {g}https://wa.me/0887239
{d}Istagram  : {g}https://www.instagram.com/nikikiy.4
{d}Youtube  : {g}https://youtube.com/Niki mark
{d}Github   : {g}https://github.com/
{d}Facebook : {g}https://facebook.com/NikigagalTenaa.r8
{ab}-----------------------------------------------""")
